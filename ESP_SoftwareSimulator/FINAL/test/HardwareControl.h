...
public:
	...
	virtual void SetSwitchInputByte(switchModes mode, bool set);
	virtual char GetSwitchInputByte();
	...
	virtual int GetActualCurrentSpeed();
...
private:
	...
	/* This variable stores the last recorded
		switch input*/
	char switchReadings = 0x00;
	...
	bool CheckSwitchClick(switchModes mode);
};
